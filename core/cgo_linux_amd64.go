...
#cgo LDFLAGS: -L${SRCDIR}/ctanker/linux-amd64/lib -ltanker_admin-c -lctanker -ltanker_async -ltankerfunctionalhelpers -ltankeradmin -ltankertesthelpers -ltankercore -ltankerstreams -ltankernetwork -ltankertrustchain -ltankeridentity -ltankercrypto -ltankerserialization -ltankererrors -ltankerlog -ltankerformat -ltankercacerts -ltccurl -lsioclient -lsqlpp11-connector-sqlite3 -lcurl -lrt -lpthread -lfmt -lsodium -lmockaron -ltconcurrent -lboost_program_options -lboost_random -lboost_context -lboost_thread -lboost_chrono -lboost_date_time -lboost_atomic -lboost_filesystem -lboost_system -lpthread -ldl -lsqlcipher -lpthread -ldl -lz -ltls -lssl -lcrypto -lpthread -static-libstdc++ -static-libgcc
*/
import "C"
